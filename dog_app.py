...
# __Answer:__  
# 
# **The face detector finds human faces in 11% of the first 100 dog photos; that's meaning identified 11 images as containing human faces (instead of dog faces) in it.**
# 
# **The face detector finds human faces in 100% of the first 100 human photos; that's meaning the algorithm "Face_detector" work done on human faces**
# 
...
# __Answer:__  
# 
# **The dog detector finds human faces in 0% of the human photo**
# 
# **The dog detector finds human faces in 100% of the human photo**
# 
# **that's meaning the algorithm "dog_detector" work done on both human faces and dogs**
...
# 
# __Answer:__  **I've learned alot anf get some help from this [article](https://towardsdatascience.com/building-a-convolutional-neural-network-cnn-in-keras-329fbbadc5f5) and [this](https://medium.com/datadriveninvestor/building-powerful-image-classification-convolutional-neural-network-using-keras-a1839d0ff298)**
# 
# # High-level steps to build the CNN to classify images are
# 
# **1_Create convolutional layers by applying kernel or feature maps**
# 
# **2_Apply Max pool for translational invariance**
# 
# **3_Flatten the inputs**
# 
# **4_Create a Fully connected neural network**
# 
# **5_Train the model**
# 
# **6_Predict the output**
# 
...
# 
# 
# **The optimizer** controls the learning rate. We will be using ‘rmsprop’ as our optmizer.The learning rate determines how fast the optimal weights for the model are calculated. A smaller learning rate may lead to more accurate weights (up to a certain point), but the time it takes to compute the weights will be longer.
# 
# 
...
def human_or_dog(img_path):
    if dog_detector(img_path):
        ...
        print("It seems like you are neither human nor dog")
        print("However, the closest dog breed of the image is ...")    
...
# 
# __Answer:__  **the output better than i expected but it could be better;**
# 
# **1_if we use more data and using Image Augmentation**
# 
...
img_path = "images/Labrador_retriever_06455.jpg"
show_img(img_path)
human_or_dog(img_path)
